    ...
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-grow p-2 lg:ml-7 ">
        <div className="relative">
          ...
          <div
            className="absolute lg:top-[2rem] justify-center lg:right-[36rem] sm:right-[16rem] Sm:right-[10rem] sm:top-[1rem] Sm:top-[0rem] md:right-[28rem] md:top-[1rem]  "
            style={{ top: logo }}
          >
            <img
              src={logo}
          ...
          <h1 className="absolute lg:top-10 left-5 right-0 text-white font-bold lg:text-2xl Sm:top-1 Sm:text-lg sm:top-1">
            Create Project
          </h1>
        </div>
